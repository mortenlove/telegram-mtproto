...
if (result.flags & 262144) result.available_reactions = this.vector(this.string);
return result;
  }],
  [3224190983, function() {
...
if (result.flags & 1073741824) result.available_reactions = this.vector(this.string);
return result;
  }],
  [182649427, function() {
...
return result;
  ...
  [1741309751, function() {
const result = { _: 'messages.translateNoResult' };
return result;
  }],
  [2719283152, function() {
const result = { _: 'messages.translateResultText' };
result.text = this.string();
return result;
  }],
  [1370914559, function() {
