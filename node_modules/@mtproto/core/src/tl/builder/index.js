const builderMap = {
  ...
  'chatFull': function(params) {
    ...
    this.flagVector(this.string, params.available_reactions);
  },
  ...
  'userFull': function(params) {
    ...
    const flags = (this.has(params.blocked) << 0) | (this.has(params.phone_calls_available) << 4) | (this.has(params.phone_calls_private) << 5) | (this.has(params.can_pin_message) << 7) | (this.has(params.has_scheduled) << 12) | (this.has(params.video_calls_available) << 13) | (this.has(params.about) << 1) | (this.has(params.profile_photo) << 2) | (this.has(params.bot_info) << 3) | (this.has(params.pinned_msg_id) << 6) | (this.has(params.folder_id) << 11) | (this.has(params.ttl_period) << 14) | (this.has(params.theme_emoticon) << 15) | (this.has(params.private_forward_name) << 16);
    this.int32(flags);
    this.long(params.id);
  ...
  'stickerSet': function(params) {
    ...
    const flags = (this.has(params.archived) << 1) | (this.has(params.official) << 2) | (this.has(params.masks) << 3) | (this.has(params.animated) << 5) | (this.has(params.videos) << 6) | (this.has(params.installed_date) << 0) | (this.has(params.thumbs) << 4) | (this.has(params.thumb_dc_id) << 4) | (this.has(params.thumb_version) << 4);
    this.int32(flags);
  ...
  'sponsoredMessage': function(params) {
    ...
    const flags = (this.has(params.from_id) << 3) | (this.has(params.chat_invite) << 4) | (this.has(params.chat_invite_hash) << 4) | (this.has(params.channel_post) << 2) | (this.has(params.start_param) << 0) | (this.has(params.entities) << 1);
    this.int32(flags);
  ...
  'reactionCount': function(params) {
    ...
    const flags = (this.has(params.chosen) << 0);
    this.int32(flags);
  ...
  'availableReaction': function(params) {
    ...
    const flags = (this.has(params.inactive) << 0) | (this.has(params.around_animation) << 1) | (this.has(params.center_icon) << 1);
    this.int32(flags);
    this.string(params.reaction);
    this.string(params.title);
  ...
  'messages.sendMedia': function(params) {
    ...
    const flags = (this.has(params.silent) << 5) | (this.has(params.background) << 6) | (this.has(params.clear_draft) << 7) | (this.has(params.noforwards) << 14) | (this.has(params.reply_to_msg_id) << 0) | (this.has(params.reply_markup) << 2) | (this.has(params.entities) << 3) | (this.has(params.schedule_date) << 10) | (this.has(params.send_as) << 13);
    this.int32(flags);
    this.predicate(params.peer);
    this.flag(this.int, params.reply_to_msg_id);
    this.predicate(params.media);
  ...
  'messages.sendReaction': function(params) {
    ...
    const flags = (this.has(params.big) << 1) | (this.has(params.reaction) << 0);
    this.int32(flags);
    this.predicate(params.peer);
    this.int(params.msg_id);
    this.flag(this.string, params.reaction);
  },
  ...
  'messages.setChatAvailableReactions': function(params) {
    ...
    this.predicate(params.peer);
    this.vector(this.string, params.available_reactions);
  },
